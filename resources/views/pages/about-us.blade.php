...
@section('content')
    ...
    <section class="py-12 md:py-16 lg:py-20 px-6 md:px-10 xl:px-16 bg-white">
        {{-- Heading About US --}}
        <div class="about-us py-5 text-3xl  md:text-4xl font-bold ">
            <h1 class="text-grey">ABOUT US <br><span class="text-hijau"> PT KALPATARU SURYA ABADI </span></h1>
        </div>
        {{-- Image For About Us  --}}
        @php
            $image_collage = [
    ...
    @endforeach
        ...
        {{-- Deskripsi Tentang PT Kalpataru Surya Abadi --}}
        <div class="py-8
                        font-light text-sm md:text-base lg:text-xl">
                    <p>PT KALPATARU SURYA ABADI yang berdiri tahun 2019 adalah pengembangan dari perusahaan sebelumnya
                        bernama CV
                    ...
                    <p>Dengan berubah status menjadi PT KALPATARU SURYA ABADI, diharapkan mampu untuk mendorong perusahaan
                        yang
                        lebih professional dengan dukungan tenaga-tenaga ahli yang berpengalaman dibidangnya.</p>
                </div>
                {{-- Vision And Mission PT Kalpataru Surya Abadi --}}
                <div class="visi-misi flex flex-col gap-5">

                    <div class="about-us py-5 text-3xl  md:text-4xl font-bold ">
                        <h1 class="text-oren">VISION AND MISSION <br><span class="text-hijau"> PT KALPATARU SURYA ABADI
                            </span></h1>
                    </div>
                    <!-- CARD 1 -->
                    <div class="card-layanan md:w-[600px]  h-[200px] bg-hijau py-8 px-10 rounded-tr-[50px]">
                    ...
                    <!-- CARD 2 -->
                    <div class="card-layanan md:w-[600px]  h-[200px] ml-auto bg-hijau py-8 px-10 rounded-tl-[50px]">
